---
title: "Confusion Matrices Permutations"
author: "Emily Kubota"
date: "7/26/2024"
output: pdf_document
---
...
df = read_csv("../../data/df_accuracy_permutations.csv",
                       col_types = cols())
...
colnames(mat_holder) <- col_names
 ...
 mat_holder %>%
  ...
  ggsave(
      filename = '../figures/4_confusion_matrices_permutations/cyto_confusion.pdf',
      width = 3,
      height = 3
    )
...
colnames(matrix_holder) <- col_names
 ...
 matrix_holder %>%
  ...
  ggsave(
      filename = '../figures/4_confusion_matrices_permutations/category_confusion.pdf',
      width = 3,
      height = 3
    )
...
ggsave(
      filename = '../figures/4_confusion_matrices_permutations/age_confusion.pdf',
      width = 3,
      height = 3
    )
